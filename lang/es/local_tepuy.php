...
$string['messageactioncron_actioncompleted'] = 'Una política ha sido completada';
$string['messageactioncron_technologycompleted'] = 'Una tecnología ha sido completada';
$string['messageactioncron_autogameover'] = 'El juego ha finalizado';
...
$string['messageactionp_gamestart'] = '{$a} ha iniciado el juego';
$string['messageactionp_changetimeframe'] = '{$a} ha cambiado la velocidad del juego';
$string['messageactionp_playaction'] = '{$a} ha jugado una política';
$string['messageactionp_playtechnology'] = '{$a} ha jugado una tecnología';
$string['messageactionp_stopaction'] = '{$a} ha detenido una política';
$string['messageactionp_stoptechnology'] = '{$a} ha detenido una tecnología';
$string['messageactionp_gameover'] = 'El juego ha sido finalizado manualmente por {$a}';
